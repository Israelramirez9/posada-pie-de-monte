    ...
    <>
      ...
      <div className='w-full flex items-center justify-center'>
        <div className=' w-4/5 flex flex-col items-center justify-center border-green-700 rounded-md border-solid border-4 p-4 m-4 bg-green-800 bg-opacity-90 text-white'>
          ...
          <h1 className='font-bold mb-2 border-b-2 inline-block w-full text-2xl'>Comidas</h1>
          <div className='h-80 flex justify-center'>
          ...
          <h1 className='font-bold mb-2 border-b-2 inline-block w-full text-2xl'>Estacionamiento</h1>
